...
module.exports = {
  ...
  warning: {
    ...
    looksLikeWindowsImage: _.template([
      'It looks like you\'ve selected a Windows image.\n\n',
      'Currently, Etcher isn\'t able to create bootable Windows disks.',
      'In the meantime we recommend you use a tool specially designed for this purpose, such as',
