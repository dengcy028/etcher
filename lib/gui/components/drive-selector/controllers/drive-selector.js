...
module.exports = function(
  ...
  this.toggleDrive = (drive) => {
    AnalyticsService.logEvent('Toggle drive', drive);
   ...
   * @public
   *
   * @param {String} method - how the modal is closed, used for logging
   *
   * @example
   * DriveSelectorController.closeModal();
   */
  this.closeModal = (method) => {
