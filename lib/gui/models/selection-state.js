...
SelectionStateModel.service('SelectionStateModel', function(DrivesModel, AnalyticsService) {
   ...
   */
  this.setImage = (image) => {
    const previouslySelected = this.getDrive();
    ...
    if (this.getDrive()) {
      AnalyticsService.logEvent('Auto-selected drive', this.getDrive());
    } else if (previouslySelected) {
      AnalyticsService.logEvent('Auto-deselected drive', previouslySelected);
    } else {
      AnalyticsService.logEvent('No drives available');
    }
  };
